...
Use the script at `.Codex/skills/yt-fetch/fetch_channel.py` to fetch videos and upload dates from a YouTube channel.

Run it with:
```
uv run .Codex/skills/yt-fetch/fetch_channel.py --channel <handle> --max <n>
```
